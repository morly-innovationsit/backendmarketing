...
//     // Handle boardpic - convert base64 string to Buffer
//     if (req.body.boardpic) {
//       try {
//         let base64Data = req.body.boardpic;
...
//           filename: `boardpic_${Date.now()}.${contentType.split('/')[1]}`
//         };
//       } catch (error) {
...
//             filename: `image_${img.type}_${Date.now()}_${i}.${contentType.split('/')[1]}`
//           });
          
//           console.log(`Successfully processed image type: ${img.type}`);
//         } catch (error) {
...
//   try {
//     const entry = await AddNew.findById(req.params.id);
